"""
Django settings for sweet_moon_dev_57116 project.
...
ROOT_URLCONF = 'sweet_moon_dev_57116.urls'
...
WSGI_APPLICATION = 'sweet_moon_dev_57116.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sweet_moon_dev_57116 API",
    "DESCRIPTION": "API documentation for sweet_moon_dev_57116 App",
    "VERSION": "v1",
}
